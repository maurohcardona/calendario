...
urlpatterns = [
    path("buscador/", views.buscador_determinaciones, name="buscador"),
    ...
    path("api/estadisticas-determinacion/", views.estadisticas_determinacion_api, name="estadisticas_determinacion_api"),
]
